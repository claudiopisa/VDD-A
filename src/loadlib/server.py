...
class Server(Server32):
    ...
    def __init__(self, host, port, **kwargs):
        ...
        self.lib.get_timestamp.restype = c_uint32
        ...
        self.lib.set_timestamp.restype = c_uint32
    ...
    def get_checksum(self, data: bytes) -> c_uint32:
        src_size = len(data)
    ...
    def set_checksum(self, data: bytes, new_checksum: c_uint32) -> bytes:
        src_size = len(data)
        src = (c_ubyte * src_size).from_buffer_copy(data)
    ...
    def get_timestamp(self, data: bytes) -> c_uint32:
        src_size = len(data)
        src = (c_ubyte * src_size).from_buffer_copy(data)
    ...
    def set_timestamp(self, data: bytes, new_timestamp: c_uint32) -> bytes:
        src_size = len(data)
        src = (c_ubyte * src_size).from_buffer_copy(data)
        err = c_uint32(0)
    ...
    def verify_checksum(self, data: bytes) -> dict:
        src_size = len(data)
        src = (c_ubyte * src_size).from_buffer_copy(data)
