...
class TaskVersioningExternal(TaskVersioning):
    ...
    def __init__(self, config: TaskVersioningConfig):
        ...
        curr_paths = self._retrieve_paths(is_prev=False)
    ...
    def _retrieve_paths(self, is_prev: bool) -> dict[str, Path | list[Path]]:
    ...
    def scan_files(self) -> TaskList:
        ...
        sys_section = ImageConfigParser(self.sys_imgconf).get_section(self.config.sys_external_section)
